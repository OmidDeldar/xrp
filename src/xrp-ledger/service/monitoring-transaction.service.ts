...
import { XrpLogDto } from "src/utils/history/dtos/xrp-log.dto";
import { HistoryService } from "src/utils/history/service/history.service";

import WebSocket from 'ws';
export class MonitoringTransactionService implements OnModuleInit{
    ...
    async connectToXrp() {
        ...
        socket.addEventListener('message', async (event: any) => {
            ...
            // let xrpTransaction = JSON.parse(event.data);
            // let xrpLogDto:XrpLogDto = {
            //     data: xrpTransaction
            // }
            // console.log(xrpLogDto);
            // await this.historyService.createXrpLog(xrpLogDto)
        })
